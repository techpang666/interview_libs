...
# **效率输出👨‍💻**
>如果一些事你觉得很有价值 但是做得不开心了 一定是你墨迹了 知道该怎么调整了吧

## **一些辅助说明**
- [一份超级面试文档🐮](https://github.com/techpang666/techpang666.github.io/blob/main/core_libs/interview_libs/interview_core/super_interview.md)
- [一些历史面试题🍖](https://github.com/techpang666/techpang666.github.io/blob/main/core_libs/interview_libs/interview_core/interview_core_libs.md)
...
------
## **第7天(210604)**
- [style标签写在body前和body后的区别是什么](https://github.com/techpang666/techpang666.github.io/blob/main/core_libs/interview_libs/interview_core/super_interview.md)
- [什么是回调函数并写一个例子](https://github.com/haizlin/fe-interview/issues/30)

------
## **第6天(210603)**
- [简述下你理解的优雅降级和渐进增强](https://github.com/techpang666/techpang666.github.io/blob/main/core_libs/interview_libs/interview_core/super_interview.md)
- [写一个判断数据类型的方法](https://github.com/haizlin/fe-interview/issues/27)

------
## **第5天(210602)**
- [清除浮动的方式有哪些及优缺点](https://github.com/techpang666/techpang666.github.io/blob/main/core_libs/interview_libs/interview_core/super_interview.md)
- [写一个把字符串大小写切换的方法](https://github.com/haizlin/fe-interview/issues/15)

------
## **第4天(210601)**
- [CSS选择器有哪些/哪些属性可以继承](https://github.com/techpang666/techpang666.github.io/blob/main/core_libs/interview_libs/interview_core/super_interview.md)
- [写一个方法把下划线命名转成大驼峰命名](https://github.com/techpang666/js_relearn/blob/master/code/str/to_camelCase.js)

------
## **第3天(210531)**
- [在页面上隐藏元素的方法有哪些](https://github.com/techpang666/techpang666.github.io/blob/main/core_libs/interview_libs/interview_core/super_interview.md)
...
- [用递归实现数组长度为5且元素的随机数在2-32间不重复的值](https://github.com/techpang666/js_relearn/blob/master/code/arr/random_arr.js)
